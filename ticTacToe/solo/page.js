...
function runSolo({ puzzle, countries }) {
   ...
   * suggestion with a tag and shake on a forced pick — a data gap or a debatable
   * count shouldn't be judged either way. Drives every commit path.
   * @param {Country} country
   */
  ...
  function pickCountry(country) {
    ...
    // Refuse a blocked pick (no-data metric gap or ambiguous colour count) — a
    // shake signals "not a valid pick here" instead of accepting it.
