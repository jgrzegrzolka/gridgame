...
**Status:** designed 2026-07-16 over six mockup rounds with Jan; UI re-cut and prototyped 2026-07-17. Parked in Backlog the same morning, then **promoted to `## Now` 2026-07-17** when Jan said *"ok, you know what. lets start building."* **Phases 1a + 1b shipped.** Next step: **Phase 1c** (the backfill), then Phase 2.
