 ...
 *   riceProbability?: number,
 *   coalProbability?: number,
 *   sheepPerCapitaProbability?: number,
 *   cattlePerCapitaProbability?: number,
 *   beerPerCapitaProbability?: number,
 *   teaProbability?: number,
 *   sugarcaneProbability?: number,
 *   goldProbability?: number,
 *   alcoholPerCapitaProbability?: number,
 *   meatPerCapitaProbability?: number,
 *   bordersProbability?: number,
 *   oliveOilProbability?: number,
 *   honeyProbability?: number,
 *   tourismPerCapitaProbability?: number,
 *   electricityPerCapitaProbability?: number,
...
export function pickRandomMix(pillPool, all, options = {}) {
  const {
    ...
    riceProbability = 0,
    coalProbability = 0,
    sheepPerCapitaProbability = 0,
    cattlePerCapitaProbability = 0,
    beerPerCapitaProbability = 0,
    teaProbability = 0,
    sugarcaneProbability = 0,
    goldProbability = 0,
    alcoholPerCapitaProbability = 0,
    meatPerCapitaProbability = 0,
    bordersProbability = 0,
    oliveOilProbability = 0,
    honeyProbability = 0,
    tourismPerCapitaProbability = 0,
    electricityPerCapitaProbability = 0,
  ...
  for (let attempt = 0; attempt < maxAttempts; attempt++) {
    ...
    const metricProbabilities = {
      ...
      oil: oilProbability,
      rice: riceProbability,
      coal: coalProbability,
      sheepPerCapita: sheepPerCapitaProbability,
      cattlePerCapita: cattlePerCapitaProbability,
      beerPerCapita: beerPerCapitaProbability,
      tea: teaProbability,
      sugarcane: sugarcaneProbability,
      gold: goldProbability,
      alcoholPerCapita: alcoholPerCapitaProbability,
      meatPerCapita: meatPerCapitaProbability,
      borders: bordersProbability,
      oliveOil: oliveOilProbability,
      honey: honeyProbability,
      tourismPerCapita: tourismPerCapitaProbability,
      electricityPerCapita: electricityPerCapitaProbability,
