...
/**
 * The "map pick" question: "Which outline is X?" — the mirror of flag-pick. The
 ...
 * `flagPick`, so the room and scoring stay question-agnostic.
 *
 ...
 * `CONTOUR_CODE_SET`. That keeps the map question self-contained: hand it any pool
