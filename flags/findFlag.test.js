...
import { categoryFromId, POPULATION_BREAKS_FOR_RANDOM, AREA_BREAKS_FOR_RANDOM, DENSITY_BREAKS_FOR_RANDOM, GDP_BREAKS_FOR_RANDOM, GDP_PER_CAPITA_BREAKS_FOR_RANDOM, COFFEE_BREAKS_FOR_RANDOM, WINE_BREAKS_FOR_RANDOM, COCOA_BREAKS_FOR_RANDOM, BANANA_BREAKS_FOR_RANDOM, ELEVATION_BREAKS_FOR_RANDOM, COASTLINE_BREAKS_FOR_RANDOM, FOREST_BREAKS_FOR_RANDOM, TEA_BREAKS_FOR_RANDOM, SUGARCANE_BREAKS_FOR_RANDOM } from './engine.js';
...
test('pickRandomMix: gdp / gdpPerCapita / coffee / wine / cocoa / banana / elevation / coastline / forest / tea / sugarcane tiers are reachable and exclusive with other scalars', () => {
