...
import { categoryFromId, POPULATION_BREAKS_FOR_RANDOM, AREA_BREAKS_FOR_RANDOM, DENSITY_BREAKS_FOR_RANDOM, GDP_BREAKS_FOR_RANDOM, GDP_PER_CAPITA_BREAKS_FOR_RANDOM, COFFEE_BREAKS_FOR_RANDOM, WINE_BREAKS_FOR_RANDOM, COCOA_BREAKS_FOR_RANDOM, BANANA_BREAKS_FOR_RANDOM, ELEVATION_BREAKS_FOR_RANDOM, COASTLINE_BREAKS_FOR_RANDOM, FOREST_BREAKS_FOR_RANDOM, TEA_BREAKS_FOR_RANDOM, SUGARCANE_BREAKS_FOR_RANDOM, GOLD_BREAKS_FOR_RANDOM, OLIVE_OIL_BREAKS_FOR_RANDOM, HONEY_BREAKS_FOR_RANDOM, MCDONALDS_PER_MILLION_BREAKS_FOR_RANDOM, NOBEL_BREAKS_FOR_RANDOM, NOBEL_PER_CAPITA_BREAKS_FOR_RANDOM, SUMMER_MEDALS_BREAKS_FOR_RANDOM, SUMMER_MEDALS_PER_CAPITA_BREAKS_FOR_RANDOM, WINTER_MEDALS_BREAKS_FOR_RANDOM, WINTER_MEDALS_PER_CAPITA_BREAKS_FOR_RANDOM } from './engine.js';
...
test('pickRandomMix: gdp / gdpPerCapita / coffee / wine / cocoa / banana / elevation / coastline / forest / tea / sugarcane / gold / oliveOil / honey tiers are reachable and exclusive with other scalars', () => {
  for (const [key, breaks, probKey] of /** @type {const} */ ([
    ...
    ['banana', BANANA_BREAKS_FOR_RANDOM, 'bananaProbability'],
    ['elevation', ELEVATION_BREAKS_FOR_RANDOM, 'elevationProbability'],
    ['coastline', COASTLINE_BREAKS_FOR_RANDOM, 'coastlineProbability'],
    ['forest', FOREST_BREAKS_FOR_RANDOM, 'forestProbability'],
    ...
    ['mcdonaldsPerMillion', MCDONALDS_PER_MILLION_BREAKS_FOR_RANDOM, 'mcdonaldsPerMillionProbability'],
    ['nobel', NOBEL_BREAKS_FOR_RANDOM, 'nobelProbability'],
    ['nobelPerCapita', NOBEL_PER_CAPITA_BREAKS_FOR_RANDOM, 'nobelPerCapitaProbability'],
    ['summerMedals', SUMMER_MEDALS_BREAKS_FOR_RANDOM, 'summerMedalsProbability'],
    ['summerMedalsPerCapita', SUMMER_MEDALS_PER_CAPITA_BREAKS_FOR_RANDOM, 'summerMedalsPerCapitaProbability'],
    ['winterMedals', WINTER_MEDALS_BREAKS_FOR_RANDOM, 'winterMedalsProbability'],
    ['winterMedalsPerCapita', WINTER_MEDALS_PER_CAPITA_BREAKS_FOR_RANDOM, 'winterMedalsPerCapitaProbability'],
  ])) {
