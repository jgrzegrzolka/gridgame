 ...
 * @typedef {{ prompt: string, options: string[], roundId?: string, clearFrac?: number }} PublicQuestion
    ...
    case 'question': {
      return {
        state: {
          ...state,
          phase: 'question',
          question: { prompt: message.prompt, options: message.options ?? [], roundId: message.roundId, clearFrac: message.clearFrac },
