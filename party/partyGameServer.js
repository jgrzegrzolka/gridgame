 ...
 */
const ROUNDS = Object.fromEntries([flagPick, mapPick, superlative, superlative.areaRound, superlative.densityRound, superlative.gdpRound, superlative.gdpPerCapitaRound, superlative.coffeeRound, superlative.elevationRound].map((m) => [m.id, m]));
