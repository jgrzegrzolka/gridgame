 ...
 */
const ROUNDS = Object.fromEntries([flagPick, mapPick, superlative, superlative.areaRound, superlative.densityRound, superlative.gdpRound, superlative.gdpPerCapitaRound, superlative.coffeeRound, superlative.wineRound, superlative.cocoaRound, superlative.bananaRound, superlative.appleRound, superlative.elevationRound, superlative.coastlineRound, superlative.forestRound, superlative.oilRound, superlative.riceRound].map((m) => [m.id, m]));
