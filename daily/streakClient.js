...
export async function fetchDailyMe(deviceId, opts = {}) {
  ...
  try {
    ...
    return {
      ...
      hasLinkedDevice: json.hasLinkedDevice === true,
      dailySharesCount: toInt(json.dailySharesCount),
      quizSharesCount: toInt(json.quizSharesCount),
      findflagSharesCount: toInt(json.findflagSharesCount),
      coffeeClicked: json.coffeeClicked === true,
      ...
      tttGamesPlayed9x9: toInt(json.tttGamesPlayed9x9),
      hasWonTtt: json.hasWonTtt === true,
      hasWon9x9: json.hasWon9x9 === true,
